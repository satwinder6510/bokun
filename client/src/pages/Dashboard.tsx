...
import { Activity, ExternalLink, RefreshCw, Database, LogOut, Star, Phone, Users, Plane, Image, Settings, FileText, Hotel, Mail, Building2 } from "lucide-react";
      ...
      <main className="container px-6 py-8">
        <div className="max-w-7xl mx-auto space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <Card data-testid="card-content-images">
              <CardHeader>
                <div className="flex items-center justify-between gap-4">
                  <div className="flex items-center gap-3">
                    <div className="flex items-center justify-center h-10 w-10 rounded-lg bg-primary/10">
                    ...
                    <div>
                      ...
                      <CardDescription>
                        Set custom images for destinations and collections
                      </CardDescription>
                    </div>
                  </div>
                  <Link href="/admin/content-images">
                    <Button variant="outline" size="sm" data-testid="button-manage-content-images">
                      Manage Images
                    </Button>
                  </Link>
                </div>
            ...
            <Card data-testid="card-city-taxes">
              <CardHeader>
                <div className="flex items-center justify-between gap-4">
                  <div className="flex items-center gap-3">
                    <div className="flex items-center justify-center h-10 w-10 rounded-lg bg-primary/10">
                    ...
                    <div>
                      <CardTitle className="text-lg">City Taxes</CardTitle>
                      <CardDescription>
                        Manage locally paid city tax rates
                      </CardDescription>
                    </div>
                  </div>
                  <Link href="/admin/city-taxes">
                    <Button variant="outline" size="sm" data-testid="button-manage-city-taxes">
                      Manage Taxes
                    </Button>
                  </Link>
                </div>
              ...
              <CardHeader>
                <div className="flex items-center justify-between gap-4">
                  ...
                  <Link href="/admin/newsletter">
                    <Button variant="outline" size="sm" data-testid="button-manage-newsletter">
                      View Subscribers
                    </Button>
                  </Link>
                </div>
